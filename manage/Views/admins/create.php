	...
	<div class="panel-body">
		<div class="col-md-12">
			...
			<p class="animated fadeInDown">
				用户 <span class="fa-angle-right fa"></span> 新增
			</p>
		</div>
	</div>
</div>
					...
					<div class="col-md-12">
						...
						<form method="post" class="cmxform" id="signupForm">
							...
							<div class="form-group form-animate-text" style="margin-top:40px !important;">
								<input type="text" class="form-text" id="validate_firstname" name="username" value="<?=old('username')?>" required>
								<span class="bar"><?= \Config\Services::validation()->showError('username'); ?></span>
								<label>登录名称</label>
							</div>
							<div class="form-group form-animate-text" style="margin-top:40px !important;">
							...
							<div class="col-md-4 col-sm-12">
								<div class="col-md-6 panel" style="padding:20px;padding-bottom:0px;">
									<div class="form-animate-radio">
										<label class="radio">
											<input id="radio1" type="radio" name="status" value="0" checked/>
											<span class="outer">
