<div class="panel">
    <div class="panel-body">
        <div class="col-md-6 col-sm-12">
            <h3 class="animated fadeInLeft">学艺购-后台管理</h3>
            <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span> -</p>

            <ul class="nav navbar-nav">
                <li><a href="javascript:void(0)">首页</a></li>
                <li><a href="javascript:void(0)" class="active">学术购买</a></li>
                <li><a href="javascript:void(0)" class="active">0元购</a></li>
                <li><a href="javascript:void(0)" class="active">私人定制</a></li>
                <li><a href="javascript:void(0)" class="active">社会实践</a></li>
                <li><a href="javascript:void(0)" class="active">招商加盟</a></li>
        ...
        <div class="col-md-6 col-sm-12">
            <div class="col-md-6 col-sm-6 text-right" style="padding-left:10px;">
                <h3 style="color:#DDDDDE;"><span class="fa  fa-map-marker"></span> 温度</h3>
        ...
        <div class="col-md-8 padding-0">
            ...
            <div class="col-md-12">
                <div class="panel box-v4">
                    <div class="panel-heading bg-white border-none">
                        <h4><span class="icon-notebook icons"></span> 待审核会员</h4>
                    </div>
                    <div class="panel-body padding-0">
                        <div class="col-md-12 col-xs-12 col-md-12 padding-0 box-v4-alert">
                            ...
                            <b><span class="icon-clock icons"></span>  15:00</b>
                        </div>
                        <div class="calendar">
                ...
                <div class="panel-body" style="padding-bottom:50px;">
                    ...
                    <div class="col-md-12 padding-0">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            ...
                            <p>Sed hendrerit. Curabitur blandit mollis lacus. Duis leo. Sed libero.fusce
                                commodo aliquam arcu..</p>
